...
/******/ 	var hotCurrentHash = "71ce8493f891aa7b9791"; // eslint-disable-line no-unused-vars
...
var user_likes_action_1 = __webpack_require__(101);
exports.createUserLikeAction = user_likes_action_1.createUserLikeAction;
exports.createUserDislikeAction = user_likes_action_1.createUserDislikeAction;
var UserMessagesActions = __webpack_require__(102);
exports.UserMessagesActions = UserMessagesActions;
var StoreActions;
(function (StoreActions) {
    StoreActions[StoreActions["LIKE_ADD"] = 0] = "LIKE_ADD";
    StoreActions[StoreActions["LIKE_REMOVE"] = 1] = "LIKE_REMOVE";
    StoreActions[StoreActions["MESSAGES_FETCH"] = 2] = "MESSAGES_FETCH";
    StoreActions[StoreActions["MESSAGES_FETCH_REQUEST"] = 3] = "MESSAGES_FETCH_REQUEST";
    StoreActions[StoreActions["MESSAGES_FETCH_SUCCESS"] = 4] = "MESSAGES_FETCH_SUCCESS";
    StoreActions[StoreActions["DEFAULT"] = 5] = "DEFAULT";
    /*SHARE,
    POST,
    MESSAGES_GET,
    MESSAGES_UPDATE,
...
var reducers_1 = __webpack_require__(103);
var actions_1 = __webpack_require__(9);
var reducerStateMap = {
    userlikedata: reducers_1.UserLikesReducer,
    usermessagesdata: reducers_1.UserMessagesReducer
};
exports.AppStore = redux_1.createStore(redux_1.combineReducers(reducerStateMap));
exports.AppStore.subscribe(function () {
    console.log("ACTON DISPATCHED, STATE WAS REDUCED");
    console.log(exports.AppStore.getState());
});
exports.AppStore.dispatch(actions_1.createUserLikeAction(2));
exports.AppStore.dispatch(actions_1.createUserLikeAction(2));
exports.AppStore.dispatch(actions_1.createUserLikeAction(2));
...
var containers_1 = __webpack_require__(100);
var history_1 = __webpack_require__(49);
...
ReactDOM.render(React.createElement(react_redux_1.Provider, { store: store_1.AppStore },
    React.createElement(containers_1.AppShell, { title: "Vinces React-Ts Scaffold" })), document.getElementById("root"));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history_createBrowserHistory__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history_createHashHistory__ = __webpack_require__(44);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history_createMemoryHistory__ = __webpack_require__(45);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(38), __webpack_require__(97)(module)))
...
var LikesComponent = (function (_super) {
    __extends(LikesComponent, _super);
    ...
    LikesComponent.prototype.handleLikeClick = function (e) {
        e.preventDefault();
        this.props.userLike(1);
        //let newCount = this.state.likes + 1;
        //this.setState({likes: newCount});
    };
    LikesComponent.prototype.handleDislikeClick = function (e) {
        e.preventDefault();
        this.props.userLike(-1);
    };
    LikesComponent.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "likesCounter" },
            React.createElement("span", { className: "likeTotal" }, this.props.likes),
            React.createElement("button", { onClick: function (e) { return _this.handleLikeClick(e); } }, "Like"),
            React.createElement("button", { onClick: this.handleDislikeClick.bind(this) }, "Dislike")));
    };
...
var mapDispatchToProps = function (dispatch) {
    return redux_1.bindActionCreators({
        userLike: _1.createUserLikeAction
    }, dispatch);
    /*return {
        userLike: () => dispatch(createUserLikeAction(1))
    }*/
};
exports.LikesCounter = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(LikesComponent);
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(0);
var appbar_1 = __webpack_require__(39);
var likecounter_1 = __webpack_require__(98);
var react_router_dom_1 = __webpack_require__(82);
...
Object.defineProperty(exports, "__esModule", { value: true });
var appshell_1 = __webpack_require__(99);
...
Object.defineProperty(exports, "__esModule", { value: true });
var _1 = __webpack_require__(9);
exports.createUserLikeAction = function (value) { return ({
    type: "LIKE_ADD",
    value: value
}); };
exports.createUserDislikeAction = function (value) { return ({
    type: _1.StoreActions.LIKE_REMOVE,
    value: value
}); };
...
var _1 = __webpack_require__(9);
var store_1 = __webpack_require__(40);
var createMessagesFetchRequestAction = function () {
    console.log("FETCHING MESSAGES FROM SERVER");
    return {
        type: _1.StoreActions.MESSAGES_FETCH_REQUEST,
        messages: []
    };
};
var createMessagesFetchSuccessAction = function (messages) { return ({
    type: _1.StoreActions.MESSAGES_FETCH_SUCCESS,
    messages: messages
}); };
exports.fetchMessages = function () {
    store_1.AppStore.dispatch(createMessagesFetchRequestAction());
    ...
    fetch("http://localhost:8080/messages")
        ...
        store_1.AppStore.dispatch(createMessagesFetchSuccessAction(messages));
    });
};
...
Object.defineProperty(exports, "__esModule", { value: true });
var user_messages_reducer_1 = __webpack_require__(105);
exports.UserMessagesReducer = user_messages_reducer_1.UserMessagesReducer;
var user_likes_reducer_1 = __webpack_require__(104);
exports.UserLikesReducer = user_likes_reducer_1.UserLikesReducer;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.UserLikesReducer = function (state, action) {
    ...
    var ACTION_KEY = (ACTION_TYPES.hasOwnProperty(action.type)) ? action.type : "DEFAULT";
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.UserMessagesReducer = function (state, action) {
    if (state === void 0) { state = []; }
    var ACTION_TYPES = {
        "MESSAGES_FETCH": function () {
            //instead of spread operator
            // return Object.assign({}, state, {likes: state.likes + action.value})
            return state.concat(action.messages);
        },
        "MESSAGES_FETCH_REQUEST": function () {
            return state.concat(action.messages);
        },
        "MESSAGES_FETCH_SUCCESS": function () {
            return state.concat(action.messages);
        },
        "DEFAULT": function () {
            return state;
